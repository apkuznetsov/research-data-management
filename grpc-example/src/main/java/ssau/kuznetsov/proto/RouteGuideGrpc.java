...
public final class RouteGuideGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ssau.kuznetsov.proto.Point,
      ssau.kuznetsov.proto.Feature> getGetFeatureMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetFeature",
      requestType = ssau.kuznetsov.proto.Point.class,
      responseType = ssau.kuznetsov.proto.Feature.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ssau.kuznetsov.proto.Point,
      ssau.kuznetsov.proto.Feature> getGetFeatureMethod() {
    io.grpc.MethodDescriptor<ssau.kuznetsov.proto.Point, ssau.kuznetsov.proto.Feature> getGetFeatureMethod;
      ...
      synchronized (RouteGuideGrpc.class) {
        if ((getGetFeatureMethod = RouteGuideGrpc.getGetFeatureMethod) == null) {
          RouteGuideGrpc.getGetFeatureMethod = getGetFeatureMethod =
              io.grpc.MethodDescriptor.<ssau.kuznetsov.proto.Point, ssau.kuznetsov.proto.Feature>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetFeature"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ssau.kuznetsov.proto.Point.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ssau.kuznetsov.proto.Feature.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ssau.kuznetsov.proto.Rectangle,
      ssau.kuznetsov.proto.Feature> getListFeaturesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListFeatures",
      requestType = ssau.kuznetsov.proto.Rectangle.class,
      responseType = ssau.kuznetsov.proto.Feature.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<ssau.kuznetsov.proto.Rectangle,
      ssau.kuznetsov.proto.Feature> getListFeaturesMethod() {
    io.grpc.MethodDescriptor<ssau.kuznetsov.proto.Rectangle, ssau.kuznetsov.proto.Feature> getListFeaturesMethod;
      ...
      synchronized (RouteGuideGrpc.class) {
        if ((getListFeaturesMethod = RouteGuideGrpc.getListFeaturesMethod) == null) {
          RouteGuideGrpc.getListFeaturesMethod = getListFeaturesMethod =
              io.grpc.MethodDescriptor.<ssau.kuznetsov.proto.Rectangle, ssau.kuznetsov.proto.Feature>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListFeatures"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ssau.kuznetsov.proto.Rectangle.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ssau.kuznetsov.proto.Feature.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ssau.kuznetsov.proto.Point,
      ssau.kuznetsov.proto.RouteSummary> getRecordRouteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RecordRoute",
      requestType = ssau.kuznetsov.proto.Point.class,
      responseType = ssau.kuznetsov.proto.RouteSummary.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<ssau.kuznetsov.proto.Point,
      ssau.kuznetsov.proto.RouteSummary> getRecordRouteMethod() {
    io.grpc.MethodDescriptor<ssau.kuznetsov.proto.Point, ssau.kuznetsov.proto.RouteSummary> getRecordRouteMethod;
    if ((getRecordRouteMethod = RouteGuideGrpc.getRecordRouteMethod) == null) {
      synchronized (RouteGuideGrpc.class) {
        if ((getRecordRouteMethod = RouteGuideGrpc.getRecordRouteMethod) == null) {
          RouteGuideGrpc.getRecordRouteMethod = getRecordRouteMethod =
              io.grpc.MethodDescriptor.<ssau.kuznetsov.proto.Point, ssau.kuznetsov.proto.RouteSummary>newBuilder()
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ssau.kuznetsov.proto.Point.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ssau.kuznetsov.proto.RouteSummary.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ssau.kuznetsov.proto.RouteNote,
      ssau.kuznetsov.proto.RouteNote> getRouteChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RouteChat",
      requestType = ssau.kuznetsov.proto.RouteNote.class,
      responseType = ssau.kuznetsov.proto.RouteNote.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<ssau.kuznetsov.proto.RouteNote,
      ssau.kuznetsov.proto.RouteNote> getRouteChatMethod() {
    io.grpc.MethodDescriptor<ssau.kuznetsov.proto.RouteNote, ssau.kuznetsov.proto.RouteNote> getRouteChatMethod;
    if ((getRouteChatMethod = RouteGuideGrpc.getRouteChatMethod) == null) {
      synchronized (RouteGuideGrpc.class) {
        if ((getRouteChatMethod = RouteGuideGrpc.getRouteChatMethod) == null) {
          RouteGuideGrpc.getRouteChatMethod = getRouteChatMethod =
              io.grpc.MethodDescriptor.<ssau.kuznetsov.proto.RouteNote, ssau.kuznetsov.proto.RouteNote>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RouteChat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ssau.kuznetsov.proto.RouteNote.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ssau.kuznetsov.proto.RouteNote.getDefaultInstance()))
  ...
  public static abstract class RouteGuideImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getFeature(ssau.kuznetsov.proto.Point request,
        io.grpc.stub.StreamObserver<ssau.kuznetsov.proto.Feature> responseObserver) {
     ...
     * </pre>
     */
    public void listFeatures(ssau.kuznetsov.proto.Rectangle request,
        io.grpc.stub.StreamObserver<ssau.kuznetsov.proto.Feature> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ssau.kuznetsov.proto.Point> recordRoute(
        io.grpc.stub.StreamObserver<ssau.kuznetsov.proto.RouteSummary> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ssau.kuznetsov.proto.RouteNote> routeChat(
        io.grpc.stub.StreamObserver<ssau.kuznetsov.proto.RouteNote> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                ssau.kuznetsov.proto.Point,
                ssau.kuznetsov.proto.Feature>(
                  this, METHODID_GET_FEATURE)))
          .addMethod(
            getListFeaturesMethod(),
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                ssau.kuznetsov.proto.Rectangle,
                ssau.kuznetsov.proto.Feature>(
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncClientStreamingCall(
              new MethodHandlers<
                ssau.kuznetsov.proto.Point,
                ssau.kuznetsov.proto.RouteSummary>(
                  this, METHODID_RECORD_ROUTE)))
          .addMethod(
            getRouteChatMethod(),
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                ssau.kuznetsov.proto.RouteNote,
                ssau.kuznetsov.proto.RouteNote>(
  ...
  public static final class RouteGuideBlockingStub extends io.grpc.stub.AbstractBlockingStub<RouteGuideBlockingStub> {
     ...
     * </pre>
     */
    public ssau.kuznetsov.proto.Feature getFeature(ssau.kuznetsov.proto.Point request) {
     ...
     * </pre>
     */
    public java.util.Iterator<ssau.kuznetsov.proto.Feature> listFeatures(
        ssau.kuznetsov.proto.Rectangle request) {
  ...
  public static final class RouteGuideFutureStub extends io.grpc.stub.AbstractFutureStub<RouteGuideFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ssau.kuznetsov.proto.Feature> getFeature(
        ssau.kuznetsov.proto.Point request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_FEATURE:
          serviceImpl.getFeature((ssau.kuznetsov.proto.Point) request,
              (io.grpc.stub.StreamObserver<ssau.kuznetsov.proto.Feature>) responseObserver);
          break;
        case METHODID_LIST_FEATURES:
          serviceImpl.listFeatures((ssau.kuznetsov.proto.Rectangle) request,
              (io.grpc.stub.StreamObserver<ssau.kuznetsov.proto.Feature>) responseObserver);
          break;
        default:
  ...
  private static abstract class RouteGuideBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ssau.kuznetsov.proto.RouteGuideProto.getDescriptor();
    }
