...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return SensorsDataProto.internal_static_SensorsData_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return SensorsDataProto.internal_static_SensorsData_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            SensorsData.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    SensorsData other = (SensorsData) obj;
  ...
  public static SensorsData parseFrom(
  ...
  public static SensorsData parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static SensorsData parseFrom(
  ...
  public static SensorsData parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static SensorsData parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static SensorsData parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(SensorsData prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public SensorsData getDefaultInstanceForType() {
      return SensorsData.getDefaultInstance();
    }

    @Override
    public SensorsData build() {
      SensorsData result = buildPartial();
    ...
    @Override
    public SensorsData buildPartial() {
      SensorsData result = new SensorsData(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof SensorsData) {
        return mergeFrom((SensorsData)other);
      } else {
    ...
    public Builder mergeFrom(SensorsData other) {
      if (other == SensorsData.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      SensorsData parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (SensorsData) e.getUnfinishedMessage();
  ...
  private static final SensorsData DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new SensorsData();
  }

  public static SensorsData getDefaultInstance() {
