...
@SpringBootTest(
        classes = DdsssApp.class,
        webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class DdsssAppTests {
    ...
    public void whenUsingRestTemplate_thenSucceed() {
        ResponseEntity<DdsssModels.Course> course = restTemplate.getForEntity(COURSE1_URL, DdsssModels.Course.class);
